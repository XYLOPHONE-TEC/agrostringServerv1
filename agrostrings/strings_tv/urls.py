...
from .views import (
    VideoViewSet, CommentViewSet, VideoCategoryViewSet,
    AgroStringsTVScheduleViewSet, RecommendedVideosView
)
...
category_detail = VideoCategoryViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'})

# AGROSTRINGS TV paths
tv_list = AgroStringsTVScheduleViewSet.as_view({'get': 'list', 'post': 'create'})
tv_detail = AgroStringsTVScheduleViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'})
